...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar la Nacionalidad que representa un atleta");
...
private void ejecutarNacionalidadAtleta()
	{
		...
		String Pais = calculadora.getNacionalidadDeAtleta(atleta);
		if (Pais != "No se encontro al Atleta")
		{
			System.out.println("El atleta buscado representa a: "+ Pais);
		}
		else {
